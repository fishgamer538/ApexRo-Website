...
const quickFaqQueries = [
  "What are the latest Rōblox security patches?",
  "How does an anti-cheat system work?",
  "What are ethical hacking practices?",
  "Explain sandboxing in game security.",
];

const GeminiFaqChat: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 px-4 bg-black text-gray-100">
      <div className="container mx-auto max-w-3xl">
        <h2 className="text-4xl font-bold text-center mb-12 text-cyan-400 drop-shadow-[0_0_3px_rgba(0,255,255,0.5)]">ApexRo Intel (Powered by Gemini) - General FAQ</h2>
        <p className="text-center text-gray-400 mb-8 max-w-2xl mx-auto">
            Seeking intelligence on the latest Roblox vulnerabilities, anti-cheat countermeasures, or advanced scripting methodologies? Our AI assistant provides real-time, grounded insights from across the digital landscape.
        </p>

        <div className="bg-gray-900 rounded-lg shadow-xl p-6 mb-8">
          <div className="mb-4 flex flex-wrap gap-2 justify-center">
            {quickFaqQueries.map((query, index) => (
              <button
                key={index}
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <input
              ...
              placeholder="e.g., What are the latest Rōblox security patches?"
              value={prompt}
